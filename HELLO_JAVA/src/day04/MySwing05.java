...
public class MySwing05 extends JFrame {
	...
	public MySwing05() {
		...
		btn.setBounds(36, 131, 126, 23);
		contentPane.add(btn);
	}
	
	private void myclick() {
		
		String na = tf_mine.getText();
		String com = "";
		String result = "";
